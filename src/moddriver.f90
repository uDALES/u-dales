...
contains
  subroutine initdriver
    use modglobal, only : ih,ib,ie,jh,jb,je,kb,ke,kh,jhc,khc,idriver,iplane,xf,lstoreplane,nstore,Uinf,ltempeq,lmoist,pi,zf,zh,driverstore,tdriverstart,tdriverdump,timeleft,dtdriver,nsv
...
!      qtmdriver = qt0driver
  ...
  subroutine writedriverfile
    ...
    use modinletdata, only : storetdriver,storeu0driver,storev0driver,storew0driver,storethl0driver,storeqt0driver,storesv0driver,nfile,nstepreaddriver
!
    implicit none
...
!
  ...
  subroutine readdriverfile
    ...
    use modinletdata, only : storetdriver,storeu0driver,storev0driver,storew0driver,storee120driver,storethl0driver,storeqt0driver,storesv0driver,nfile
