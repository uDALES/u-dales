...
contains
  ...
  subroutine closure
    ...
    elseif(lvreman) then
       ...
       !! Old implementation of buoyancy correction; not consistent with uDALED v2.0 onwards.
       !! D. Majumdar and X. Long have decided to replace the following implementation with above.
       !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       !  if ((lbuoyancy) .and. (lbuoycorr)) then
