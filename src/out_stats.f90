...
!          call stats_write_tavg_vel
    ...
    subroutine stats_createnc_tavg1d
    ...
    end subroutine stats_createnc_tavg1d
    ...
    subroutine stats_write_tavg_vel1d
      implicit none
    ...
    end subroutine stats_write_tavg_vel1d
