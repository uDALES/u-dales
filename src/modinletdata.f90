...
! Inlet driver simulation variables - idriver - ae1212
    ...
    real, allocatable, pinned :: v0driver(:,:)
    real, allocatable, pinned :: w0driver(:,:)
    real, allocatable, pinned :: thl0driver(:,:)
    real, allocatable, pinned :: qt0driver(:,:)
    real, allocatable, pinned :: sv0driver(:,:,:)
    real, allocatable, pinned :: umdriver(:,:)
    real, allocatable, pinned :: vmdriver(:,:)
    real, allocatable, pinned :: wmdriver(:,:)
    real, allocatable, pinned :: thlmdriver(:,:)
    real, allocatable, pinned :: qtmdriver(:,:)
    real, allocatable, pinned :: svmdriver(:,:,:)
#else
