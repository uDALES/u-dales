...
module advection_2nd
   ...
   contains
      ...
      subroutine advecc_2nd(hi, hj, hk, putin, putout)
         use modglobal, only: kb, ke, ib, ie, jb, je, dxi5, dyi5, dzf, dzfi5, dzhi
      ...
      subroutine advecu_2nd(putin, putout)
         use modglobal, only: ib, ie, ih, jb, je, jh, kb, ke, kh, dxi, dxiq, dyiq, dzf, dzfi5, dzhi
      ...
      subroutine advecv_2nd(putin, putout)
         use modglobal, only: ib, ie, ih, jb, je, jh, kb, ke, kh, dxiq, dyi, dyiq, dzf, dzfi5, dzhi
         use modfields, only: u0, v0, w0, pres0
         implicit none
      ...
      subroutine advecw_2nd(putin, putout)
         use modglobal, only: ib, ie, ih, jb, je, jh, kb, ke, kh, dxiq, dyiq, dzf, dzhi, dzhiq
         use modfields, only: u0, v0, w0, pres0
         implicit none
