...
subroutine tstep_integrate
  ...
  use modglobal, only : ib,ie,jb,jgb,je,kb,ke,nsv,dt,rk3step,e12min,lmoist,timee,ntrun,&
                        ...
                        dzf,dzhi,dzf,dxhi,dxf,ifixuinf,thlsrc,lchem,BCxm,BCxT,BCxq,BCxs
  ...
  use modfields, only : u0,um,up,v0,vm,vp,w0,wm,wp,&
                        ...
                        wouttot,dpdxl,dgdt,momfluxb,tfluxb,qfluxb,div
  ...
  use modboundary, only : cyclicmj, cyclichj, cyclicqj, cyclicsj, cyclicmi, cyclichi, cyclicqi, cyclicsi
  implicit none
