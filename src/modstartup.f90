...
module modstartup
   ...
   subroutine startup
      ...
      use modglobal, only:initglobal, iexpnr, runtime, dtmax,  &
         ...
         lwallfunc,lprofforc,lchem,k1,JNO2,rv,rd,tnextEB,tEB,dtEB,bldT,flrT,wsoil,wgrmax,wwilt,wfc,skyLW,GRLAI,rsmin,nfcts,lEB,lwriteEBfiles,nwalllayers,lconstW, &
