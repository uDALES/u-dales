...
module modstartup
   ...
   subroutine broadcast_config_parameters
      !-----------------------------------------------------------------|
      !                                                                 |
      !     Broadcast all configuration parameters to all processes     |
      ...
      ! Extended parameters - add more as needed
      ...
      ! More parameters can be added here as needed
      ! For now, including the most essential ones
