...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine checksim
    ...
    if (myid==0) then
      ...
      write (*,*) '================================================================='
      write (*,'(3A,F9.2,A,F6.3)') 'Time of Day: ', timeday(1:10),'    Time of Simulation: ', timee, '    dt: ',dtmn
    end if
    call calccourant
    call calcpeclet
    call chkdiv
...
!-----------------------------------------------------------------|
    ...
    use modfields, only : u0,v0,w0,u0av
    ...
    if (myid==0) then
      ...
      write(*,'(A,3ES10.2,I5,ES10.2,I5,F8.3)') 'Courant numbers (x,y,z,tot):',courx,coury,maxval(courz(1:kmax)),maxloc(courz(1:kmax)),maxval(courtot(1:kmax)),maxloc(courtot(1:kmax)),u0av(53)
    end if
