...
##gfortran -O3 -march=native -fopenmp $DA_TOOLSDIR/syntheticInflow/modSyntheticInflow.f90 -lfftw3 -o synInflow_executable

ftn -O3 -h omp $DA_TOOLSDIR/syntheticInflow/modSyntheticInflow.f90 -lfftw3 -o synInflow_executable
...
## export OMP_NUM_THREADS=128    ## please increase this for large job based on availability of cores
