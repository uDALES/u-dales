!> \file IBM_preproc_driver.f90
!! Callable driver for the IBM preprocessor.
!>
!
...
contains
    ...
    subroutine run_ibm_preproc()
        ...
        real   , allocatable, dimension(:)     :: secareas_w, bnddst_w, secareas_c, bnddst_c
