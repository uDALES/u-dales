function [ distances, surface_points, face, typeid, faces2, vertices2, corresponding_vertices_ID, new_faces_ID ] = point2trimesh( varargin )
% ------------------------------------------------------
%
...
if nargout>4, insertPoints = true;
...
switch parser.Results.Algorithm
    case {'linear','normal'}
        for r = 1:nQPoints
            ...
            [d,p,f,id] = processPoint(faces,vertices,point,normals, @distance_to_vertices,@distance_to_edges,@distance_to_surfaces, useSubSurface);
            D(r) = d;
            P(r,:) = p;
            F(r) = f;
            I(r) = id;
...
function [D,P,F,I] = processPoint(faces,vertices,point,normals, distance_to_vertices,distance_to_edges,distance_to_surfaces, useSubSurface)
...
% f:  (#connectedFaces x 1) face indices
