function var_filtered = coarse_graining(var, Lflt, dx, xm, ym)
% coarse_graining  Apply spatial filtering to 3D field data using FFT-based convolution
%
%   var_filtered = coarse_graining(var, Lflt, dx, xm, ym)
%
...
%   u_filtered = coarse_graining(u_data, filter_lengths, obj.dx, obj.xm, obj.ym);
%
