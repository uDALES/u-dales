    ...
    if r.lEB
        ...
        elseif r.ishortwave == 2
            ...
            msg = ['On MATLAB write_inputs path, ishortwave == 2 runs the MATLAB version of the scanline rasterization ' ...
                   ...
                   'Neither of the above considers vegetation for radiation calculation. Vegetation is only included in the write_inputs python suite for (ishortwave == 2 or ishortwave == 3).'];
            disp(msg);
        else
