#!/usr/bin/env python3
"""
Compare u-DALES output files across multiple experiment cases (all pairwise combinations).
...
# ---------------------------------------------------------------------------
# Load ud_compare_outputs from the same tools/ directory
# ---------------------------------------------------------------------------

def _load_ud_compare_outputs():
    here = os.path.dirname(os.path.abspath(__file__))
    module_path = os.path.join(here, 'ud_compare_outputs.py')
    spec = importlib.util.spec_from_file_location('ud_compare_outputs', module_path)
...
def main():
    ...
    log_path = os.path.join(_logdir, f"ud_compare_multiple_outputs_{timestamp}.log")

    # Print run header
    sep = "=" * 70
    print(sep)
    print("ud_compare_multiple_outputs")
    print(sep)
