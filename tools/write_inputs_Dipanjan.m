...
expnr = '198'; %This one is the tile
expnr2 = '199'; %This is the actual full scale experiment.
xtiles = 3;
ytiles = 2;
tic
...
%         end
        ...
        preprocessing.write_netsw(r, Knet_tile);
        tiles = xtiles*ytiles;
...
%cd(fpath2)
efctvalb = 1-sum(Knet_tile)/sum(Sdir+r.Dsky*svftile);
