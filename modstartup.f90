...
!            use modsurface,        only : initsurface
          ...
          !declare namelists
            ...
            namelist/RUN/ &
                ...
                author,linoutflow,lper2inout,libm,ltrees,lnudge,tnudge,nnudge,lpurif,lles,lwallfunc,lmassflowr,lreadmean,& 
                startmean,lscalinout,lscalrec,lSIRANEinout,lydump,lytdump,lxydump,lxytdump,lslicedump,ltdump,ltkedump,lscasrc,lscasrcl,ltempinout,lmoistinout,lzerogradtop,lzerogradtopscal,lwalldist,lstore3d,lstorexz,&
                ltfluxtop,ltfluxbot,randu,nkplane,kplane,nsvl,nsvp,ifixuinf,lvinf,tscale,dpdx
            namelist/DOMAIN/ &
                imax,jtot,kmax,&
                xsize,ysize,&
            ...
            namelist/INLET/ &
                iinletgen,Uinf,Vinf,di,dti,iplane,inletav,linletRA,lstoreplane,lreadminl,lfixinlet,lfixutauin,xS,yS,zS,&
                SS,sigS
            namelist/WALLS/ &
...
write(*,*) "starting broadcast" 
            ...
            call MPI_BCAST(lSIRANEinout,1,MPI_LOGICAL,0,comm3d,mpierr)
            ...
            call MPI_BCAST(iinletgen  ,1,MPI_INTEGER,0,comm3d,mpierr)        ! J.Tomas: 0: no inletgen, 1: Lund (1998), 2: read inlet from file
...
!            call initsurface
          ...
          !-----------------------------------------------------------------|
            ...
            use modglobal, only : imax,kmax,jtot,ysize,xsize,dtmax,runtime, startfile,lwarmstart,lstratstart
