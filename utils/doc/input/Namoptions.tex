...
\begin{supertabular}{|l|p{1.6cm}|p{5cm}|p{6.3cm}|l|}
  ...
  xsize		& -		& $x \in \mathbb{N}^*$		& Horizontal size of the simulated domain	& m\\
  ysize		& -		& $x \in \mathbb{N}^*$		& Horizontal size of the simulated domain	& m\\
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  ...
  lqlnr		& .false.	& $x\in\{\text{.false.},\text{.true.}\}$		& Switch for Newton-Raphson approximation of the liquid water content	& -\\
  \qquad	&		&				&							&\\
  \multirow{7}{*}{\begin{tabular}{@{\hspace{0cm}}l}iadv\_mom\\iadv\_tke\\iadv\_thl\\iadv\_qt\\iadv\_sv \end{tabular}$\left. \begin{tabular}{l} \\ \\ \\ \\ \\ \end{tabular} \right\}$} & \multirow{7}{*}{5} & \multirow{7}{*}{$x \in \{1,2,4,5,6,7\}$}	& Advection scheme for momentum, TKE, $\theta_l$, $q_t$ and scalars: & \multirow{7}{*}{-}\\
  	&		&				& 1 = 1$^{\text{st}}$ order upwind					&\\
  	&		&				& 2 = 2$^{\text{nd}}$ order central difference			&\\
  	&		&				& 4 = 4$^{\text{th}}$ order central difference			&\\
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  thls		& -		&  $x \in \mathbb{R}, \quad x>0$		& Liquid water potential temperature at the surface	& K\\
  ps		& -		&  $x \in \mathbb{R}, \quad x>0$		& Pressure at the surface			& Pa\\
  &&&&\\
  isurf		& -		& $x \in \{1,2,3,4\}$			& \begin{tabular}{@{\hspace{0cm}}p{6cm}}Flag for surface parametrization\\1 = Interactive scheme (using radiation)\\2 = Forced surface temperature; fluxes are calculated\\3 = Forced momentum, moisture and heat flux; surface temperature is calculated\\4 = Forced moisture and heat flux; $u_*$ and surface temperature are calculated\\\end{tabular}	& -\\
  &&&&\\
  z0		& -		& $x \in \mathbb{R}, \quad x>0$		& Surface roughness				& m\\
  ustin		& -		& $x \in \mathbb{R}, \quad x>0$			& Prescribed friction velocity			& m s$^{-1}$\\
  wtsurf	& -		& $x \in \mathbb{R}, \quad x>0$		& Flux of liq. water pot. temp. at the surface	& K m s$^{-1}$\\
  wqsurf	& -		& $x \in \mathbb{R}$		& Flux of total water content 			& kg kg$^{-1}$\\
  wsvsurf(1:nsv)& 0		& $x \in \mathbb{R}$	& Flux of scalar n at the surface		& -\\
  ...
  \qquad	&		&				&						& \\
  \multirow{5}{*}[-14pt]{iradiation} & \multirow{5}{*}[-14pt]{2} & \multirow{5}{*}[-14pt]{$x \in \{0, 1, 2, 10\}$}	& Flag for radiation calculations & \multirow{5}{*}[-14pt]{-}\\
  & & & 0 = No radiation &\\
  ...
  \qquad	&		&				&						& \\
  \multirow{8}{*}{irad} & \multirow{8}{*}{-1}	& \multirow{8}{*}{$x \in \{-1,0,1,2,3,4,10\}$}	& Flag to force (iradiation, rad\_ls, rad\_longw, rad\_shortw, rad\_smoke) & \multirow{8}{*}{-}\\ 
  	& & & -1 = - & \\
  	& & & 0 = (0,-,-,-,-) & \\
  ...
  sfc\_albedo	& 0.05		& $x \in \mathbb{R}, \quad 0 \leq x \leq 1$	& Surface albedo					& -\\
...
\begin{supertabular}{|l|p{1.6cm}|p{4.4cm}|p{6cm}|l|}
  ...
  courant	& 1.4 or 3	& $x \in \mathbb{R}, \quad x>0$		& Courant number				& -\\
  peclet	& 0.2		& $x \in \mathbb{R}, \quad x>0$		& Peclet number					& -\\	
\end{supertabular}
\end{center}
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  tcheck	& dtmax	& $x \in \mathbb{R}, \quad x>0$	& Time interval between checks of velocity divergence and Courant numbers	& s\\
\end{supertabular}
\end{center}
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  ...
  dtav		& dtav\_glob	& $x = n \cdot \text{dtmax}, \quad n \in \mathbb{N}^*$	& Time interval for sampling of statistics	& s\\
  crossheight	& 2		& $x \in \mathbb{N}, \quad 1 \leq x \leq \text{kmax}$	& Height of the horizontal crosssection		& -\\
  crossplane	& 2		& $x \in \mathbb{N}, \quad 1 \leq x \leq \text{kmax}$	& Location of the vertical (yz) plane on every processor& -\\
\end{supertabular}
\end{center}
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
\multirow{3}{*}[-14pt]{imicro}	& \multirow{3}{*}[-14pt]{0}	& \multirow{3}{*}[-14pt]{$x \in \{0,2\}$}	& Flag for the microphysical scheme:			& \multirow{3}{*}[-14pt]{-}\\
  ...
  Nc\_0		& 100e6			& $x \in \mathbb{R}, \quad x \ge 0$	& Initial number of cloud droplets			& -\\
  sig\_g	& 1.5			& $x \in \mathbb{R}, \quad x \ge 0$	& Geometric standard deviation of the cloud droplet drop size distribution			& -\\
...
\begin{supertabular}{|l|p{2cm}|p{4cm}|p{6cm}|l|}
  lradstat	& .false.	& $x\in\{\text{.false.},\text{.true.}\}$	& Switch for calculating slabaveraged radiation statistics	& -\\
  dtav		& dtav\_glob	& $x = n \cdot \text{dtmax}, \quad n \in \mathbb{N}^*$	& Time interval for sampling of statistics	& s\\
  timeav	& timeav\_glob	& $x = n \cdot \text{dtav}, \quad n \in \mathbb{N}^*$	& Time interval for writing statistics		& s\\
\end{supertabular}
\end{center}
...
\begin{supertabular}{|l|p{1.6cm}|p{4cm}|p{6cm}|l|}
  isurf	& -1	& $x \in \{1,2,3,4\}$	& Overrides isurf flag of Namelist \hyperref[par:physics]{PHYSICS} if used. & -\\
  ...
  wsvsurf	& -	& $x \in \mathbb{R}[100]$	& Prescribed surface scalar flux & ppb m s$^{-1}$\\ 
  ...
  lsea	& .true.	& $x\in\{\text{.false.},\text{.true.}\}$	& Switch to model sea surface (if isurf = 2) & -\\
  rsisurf2	& -1	& $x \in \mathbb{R}, \quad x \ge 0$	& Vegetation resistance (if isurf = 2)	& s m$^{-1}$\\
\end{supertabular}
\end{center}
