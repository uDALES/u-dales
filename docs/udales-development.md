...
- Software docs — API documentation of the Fortran source, generated with [FORD](https://github.com/Fortran-FOSS-Programmers/ford). Note that this is built separately from the main site (see the development notes), so the link only works on the published documentation.
