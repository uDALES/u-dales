...
| nompthreads    | 8       | `INTEGER` > 0   | Number of OpenMP threads used by preprocessing routines that support OpenMP. `write_inputs.sh` also uses this value for the preprocessing CPU request. | - |
