...
uDALES is an open-source multi-physics microscale urban modelling tool, capable of performing large-eddy simulation (LES) of urban airflow, heat transfer, and pollutant dispersion. It resolves buildings with a conservative immersed boundary method, includes a full urban surface energy balance with radiation, vegetation, and moisture, and scales to large domains on HPC systems.
...
-   :material-download:{ .lg .middle } **Installation**
    ...
    Build uDALES on Linux, macOS, WSL, or HPC clusters — or use the ready-made Singularity image.
...
uDALES is developed openly on [GitHub](https://github.com/uDALES/u-dales). See the [development notes](DEVELOP.md) and [contribution guide](CONTRIBUTING.md) to get involved.
