...
-   :material-console-line:{ .lg .middle } **Running cases**

    ---

    Run cases with the repository wrapper scripts and standard workflow.

    [:octicons-arrow-right-24: Running uDALES](udales-simulation-setup.md)
...
-   :material-test-tube:{ .lg .middle } **Testing**
    ...
    Current test layout, fixture locations, and test-suite entry points.

    [:octicons-arrow-right-24: Test layout](../tests/README.md)
...
uDALES is developed openly on [GitHub](https://github.com/uDALES/u-dales). See the [developer documentation](udales-development.md), [contribution guide](udales-contributing.md), and [agent guidance](udales-agents.md) to get involved.
