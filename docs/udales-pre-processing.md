...
- `vf.nc.inp`: view factors of facets.
...
- `blockheight`: height of blocks (cells). Required when using `lcube`, `lcastro`, or `lcanyons`. Default: 16.
- `blockwidth`: width of blocks (cells). Required when using `lcube`, `lcastro`, or `lcanyons`. Default: 16.
- `canyonwidth`: width of canyon (cells). Reuired when using `lcanyons`. Default: 16.
